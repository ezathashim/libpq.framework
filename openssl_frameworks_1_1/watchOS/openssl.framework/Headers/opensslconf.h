...
#elif TARGET_OS_WATCH && TARGET_OS_EMBEDDED && TARGET_CPU_ARM && !defined(__ARM_ARCH_7K__)
# include <openssl/opensslconf_watchos_armv7k.h>
#elif TARGET_OS_WATCH && TARGET_OS_EMBEDDED && TARGET_CPU_ARM64 && !defined(__ARM_ARCH_64_32__)
